...
export function Textarea({ onDark = false, invalid = false, rows = 4, style, ...rest }) {
  ...
  return (
    <textarea
      ...
      style={{ ...control(onDark, invalid, focused), resize: "vertical", lineHeight: "var(--lh-body)", ...style }}
      {...rest}
    />
  );
}
